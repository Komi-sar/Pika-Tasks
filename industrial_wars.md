...
- [ ] Рандомизация спавна для каждой из руд

- [ ] Автоматическое выключение палки(фонарика) при перезарядке и взаимодействии с энтити зероса
...
- [ ] Удобный селектор команд в режиме строительства.
